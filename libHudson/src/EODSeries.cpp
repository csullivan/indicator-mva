...
*
* $Id: EODSeries.cpp, v1.1 2013-07-28  mreid Exp $
*
...
Series::EODSeries::ThisMap::const_iterator Series::EODSeries::first_in_week( const boost::gregorian::date& d ) const
{
  return first_in_week( d.year(), d.month(), d.day() );
}
