...
*
* $Id: EODSeries.hpp,v1.1 2013-07-28  mreid Exp $
*
  ...
  */
  ...
  public:
    ...
    */    
    ...
    //! Returns the last data series entry of the week for the specifiefrom_strind year/month/day.
    /*!
    ...
    */
    ...
    ThisMap::const_iterator first_in_week( const boost::gregorian::date& d ) const;
    ...
    */    
    ...
    //ThisMap::const_iterator last_in_week( const boost::gregorian::date& d ) const;
